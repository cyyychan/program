...
//	char fileName[100] = argv[1];
	...
	{   
		...
		morphologyEx(fgMaskMOG, morpho, cv::MORPH_OPEN, element);
		morphologyEx(fgMaskMOG, morpho, cv::MORPH_CLOSE, element);
		...
		/**
				C O N V E X   H U L L
		**/
		ConvexHull(mascara, mascara, frame2, output, threshold_output);
